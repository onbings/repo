...
protected:
    void sink_it_(const details::log_msg &msg) override
    {
        ...
        {
//BHA          file_helper_.open(FileNameCalc::calc_filename(base_filename_, now_tm(msg.time)), truncate_);
//BHA
          spdlog::filename_t filename;
          filename = FileNameCalc::calc_filename(base_filename_, now_tm(msg.time));
          file_helper_.open(filename, truncate_);
          this->LogChannelPathName(filename);
