...
public:
    ...
    void format(const details::log_msg &msg, fmt::memory_buffer &dest, bool _LogHeaderVisible_B) override
    {
#ifndef SPDLOG_NO_DATETIME
      ...
      //BHA
        ...
        {
          if (formatters_.size() >= 2)
          {
            formatters_[formatters_.size() - 2]->format(msg, cached_tm_, dest);
            formatters_[formatters_.size() - 1]->format(msg, cached_tm_, dest);
          }
        }
